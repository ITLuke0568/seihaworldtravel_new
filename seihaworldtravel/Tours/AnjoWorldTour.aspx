<%@ Page Title="Anjo World Day Adventure" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AnjoWorldTour.aspx.cs" Inherits="seihaworldtravel.Tours.AnjoWorldTour" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('../../assets/dot/anjo_header.jpg');">
        <div class="container position-relative">
            <h1>Anjo World Day Adventure</h1>
            <p>Cebu's First World-Class Theme Park</p>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered tour-table mb-4 text-center" style="font-size: 0.85rem;">
                                ...
                                <tbody class="fw-bold">
                                    ...
                                    <tr><td>2</td><td>PHP 2,800</td><td>PHP 3,400</td></tr>
                                    <tr><td>3</td><td>PHP 2,200</td><td>PHP 2,800</td></tr>
                                    <tr><td>4</td><td>PHP 1,900</td><td>PHP 2,500</td></tr>
                                    <tr><td>5</td><td>PHP 1,700</td><td>PHP 2,300</td></tr>
                                    <tr><td>6-12</td><td>PHP 1,500</td><td>PHP 2,100</td></tr>
                                </tbody>
                            </table>
                        </div>

                        <div class="mb-5">
                            <h5 class="fw-bold text-primary border-bottom pb-2">Option A: Day Adventure Pass</h5>
                            <p class="small mb-4"><strong>Highlights:</strong> <br />
                                <strong><u>Family Rides</u></strong> Golden Carousel, London Taxi, Space Shuttle, Anjo Eye, Bumper Boats, Mr. Cup & Mr. Toad<br />
                                <strong><u>Extreme/Thrill Rides</u></strong> Boomerang, Hip-Hop, Viking, Tower Drop, & The Pharaoh<br />
                                <strong><u>Kiddie Rides</u></strong> Ball Pit, Mini Tower Drop & Kid’s Train<br />
                            <strong>Inclusions:</strong> Air-con Transpo, Anjo World Entrance & Unlimited Ride Pass, and Hotel Pick-up/Drop-off.</p>

                            <h5 class="fw-bold text-primary border-bottom pb-2">Option B: Adventure Pass + Snow World</h5>
                            <p class="small"><strong>Highlights:</strong> All unlimited rides<br />
                                <strong><u>CEBU OCEAN PARK </u></strong><br />
                                Admission to: Jungle Trek, Creepy Critters, Seven Seas, Lorries Loft, Amphitheater Bird Show, Crocodile Lair Exhibit, Oceanarium, Main Tank Gallery <br />
                                <strong>Exclusions:</strong> Meals, Snow World, Funtastic Arena  Game <br />


                            <strong>Inclusions:</strong> Air-con Transpo, Anjo World Unlimited Pass, Snow World Entrance Ticket, and Hotel Pick-up/Drop-off.</p>
                            
                            <div class="mt-3 p-2 border-top">
                                <strong>Note:</strong> Proper attire is required for Snow World (Jackets are provided). Rides are subject to height requirements and maintenance schedules.
                            </div>
                        </div>
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            <tbody>
                                <tr>
                                    ...
                                    <td>Net Rates each per person including pertinent taxes and service charge.<br /></td>
                                </tr>
                                <tr><th class="bg-light">Schedule</th><td>Wednesday to Sunday</td>
                                </tr>
                                <tr><th class="bg-light">Duration</th><td>
                                    <strong><u>Package A:</u></strong>5 Hrs &emsp; Pickup Time: 1:00 PM<br />
                                    <strong><u>Package B:</u></strong>8 Hrs &emsp; Pickup Time: 10:00 AM<br /> </td></tr>
                                <tr><th class="bg-light">Location</th><td>Minglanilla, Cebu</td></tr>
                                  <tr>
                ...
                <div class="col-lg-5">
                    <div class="p-4 shadow-sm rounded bg-white border" style="position: sticky; top: 100px;">
                        ...
                        <div class="mb-3">
                            ...
                            <asp:DropDownList ID="ddlAnjoPass" runat="server" CssClass="form-select">
                                <asp:ListItem Text="Option A: Unlimited Rides Only" Value="Rides"></asp:ListItem>
                                <asp:ListItem Text="Option B: Rides + Snow World" Value="Snow"></asp:ListItem>
                            </asp:DropDownList>
                        </div>
